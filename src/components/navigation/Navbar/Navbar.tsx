...
export const Navbar = () => {
    ...
    return (
        <nav className="navbar navbar-expand-lg navbar-light fixed-top px-3 pt-2" style={{ backgroundColor: "#2583c5" }}>
            ...
            <div className="collapse navbar-collapse" id="navbarText">
                <ul className="navbar-nav mr-auto">
                    <li className="nav-item active">
                        <a className="nav-link btn btn-light btn-outline-primary" href="/home"><i className="bi bi-house"></i>Home</a>
                    </li>
